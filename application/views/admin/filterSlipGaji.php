...
<div class="card mx-auto" style="width: 35%;">
	...
	<div class="card-body">
		...
		<div class="form-group row">
			<label for="inputPasssword" class="col-sm-3 col-form-label">Nama Pegawai</label>
			<div class="col-sm-9">
		...
		<button style="width: 100%;" type="submit" class="btn btn-primary"><i class="fas fa-print col-sm-1"></i>Cetak Slip Gaji</button>
	</div>
</div>
</form>
